...
@ options passed:  -nostdinc -I include -I ./arch/arm/include -imultilib sf
@ -imultiarch arm-linux-gnueabi -D __KERNEL__ -D __UBOOT__
@ -D CONFIG_SYS_TEXT_BASE=0x87800000 -D __ARM__ -D DO_DEPS_ONLY
...
.LASF57:
	...
	.ascii	"ccess -mfloat-abi=soft -march=armv7-a -mfpu=vfpv3-d"
	.ascii	"16 -mtls-dialect=gnu -g -Os -fno-builtin -ffreestan"
	.ascii	"ding -fno-stack-protector -fstack-usage -ffunction-"
...
.LASF59:
	.ascii	"/home/sagnik/udoo-neo-os-builds/uboot-imx\000"
.LASF5:
